var level_03 = {
	...
	create: function () {
		...
		this.fruit = game.add.sprite(171, 2432, 'fruit');
		...
		this.fruit.animations.play('coconut');

		game.physics.arcade.enable(this.fruit);
		this.fruit.body.collideWorldBounds = true;

		this.fruit2 = game.add.sprite(3850, 2016, 'fruit');
		...
		this.fruit2.animations.play('grapes');
